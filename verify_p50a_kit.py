...
WORKFLOW=ROOT/'.github/workflows/build-subsdk9-p50a.yml'
...
wf=WORKFLOW.read_text(); assert 'P48C' not in wf and 'build-subsdk9-p50a.yml' in wf
assert 'deploy/atmosphere/contents/0100FA10190A0000/exefs/main' in wf
print('P50A_KIT_VERIFY=PASS')
