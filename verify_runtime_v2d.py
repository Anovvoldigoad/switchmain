...
wf=(root/'.github/workflows/build-runtime-v2d.yml').read_text()
...
checks={
 ...
 'v2d_markers': '[NSC:V2D] RESOLVER_READY' in rt and '[NSC:V2D] RUNTIME_PATCH_READY' in rt,
 'original_main_readme': '2579b0cb85b79d5515a2518caeb5d5721168dbc1ec3f92c46eb372d13488ecd9' in (root/'README_RUNTIME_V2D.md').read_text(),
 'workflow_only_v2d': len(list((root/'.github/workflows').glob('*.yml')))==1 and 'NSC-RUNTIME-V2D-original-main-runtime-patch' in wf,
...
print('NSC_RUNTIME_V2D_SOURCE_VERIFY=PASS')
